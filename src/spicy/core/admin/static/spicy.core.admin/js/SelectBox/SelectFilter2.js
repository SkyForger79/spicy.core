...
var SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_media_prefix) {
        ...
        quickElement('span', filter_p, '&nbsp;', 'class', 'ui-icon custom_ui-icon ui-icon-search-2');
        ...
        var add_link = quickElement('i', quickElement(
            'a', selector_chooser, '', 'class', 'ui-corner-all custom_ui-icon icon',
            'href', 'javascript: (function(){ SelectBox.move("' + field_id + '_from","' + field_id + '_to");})()'), gettext('Add'));
        add_link.className = 'ui-icon custom_ui-icon ui-icon-arrow-2-e';
        var remove_link = quickElement('i', quickElement(
            'a', selector_chooser, '', 'class', 'ui-corner-all icon',
            'href', 'javascript: (function(){ SelectBox.move("' + field_id + '_to","' + field_id + '_from");})()'), gettext('Remove'));
        remove_link.className = 'ui-icon custom_ui-icon  ui-icon-arrow-2-w';
